                    ...
                    <!-- Basic example -->
                        ...
                        <div class="col-md-8">
                            <div class="panel panel-default">
                               <div class="panel-heading"><h3 class="panel-title">Edit Yearly Expense
                               ...
                               @if ($errors->any())
                                ...
                                <div class="panel-body">
                            		<form role="form" action="{{ url('update-yearly-expense/'.$edity->id) }}" method="post">
                            			@csrf
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Expense Details</label>
                                            <input type="text" class="form-control" name="details" value="{{$edity->details}}" required></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Amount</label>
                                            <input type="text" class="form-control" name="amount" value="{{$edity->amount}}" required>
                                        </div>

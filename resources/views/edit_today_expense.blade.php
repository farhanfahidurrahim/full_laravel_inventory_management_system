                            ...
                            <div class="panel panel-default">
                               ...
                               @if ($errors->any())
                                ...
                                <div class="panel-body">
                            		<form role="form" action="{{ url('update-today-expense/'.$editt->id) }}" method="post">
                            			@csrf
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Expense Details</label>
                                            <input type="text" class="form-control" name="details" value="{{$editt->details}}" required></textarea>
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Amount</label>
                                            <input type="text" class="form-control" name="amount" value="{{$editt->amount}}" required>
                                        </div>

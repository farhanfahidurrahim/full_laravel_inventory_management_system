                        ...
                        <div id="sidebar-menu">
                            <ul>
                                ...
                                <li class="has_sub">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><a href="{{ route('addadvncd.salary')}}">Add Advanced Salary</a></li>
                                        <li><a href="{{ route('alladvncd.salary')}}">All Advanced Salary</a></li>
                                        <li><a href="{{ route('pay.salary')}}">Pay Salary</a></li>
                                        {{-- <li><a href="{{ route('alladvncd.salary')}}">Last Month Salary</a></li> --}}
                                    </ul>
                                </li>
                                ...
                                <li class="has_sub">
                                    <a href="#" class="waves-effect"><i class="md md-pages"></i><span> Attendence</span><span class="pull-right"><i class="md md-add"></i></span></a>
                                    <ul class="list-unstyled">
                                ...
                                <li class="has_sub">
                                    <a href="#" class="waves-effect"><i class="md md-pages"></i><span>Export | Import</span><span class="pull-right"><i class="md md-add"></i></span></a>
                                    <ul class="list-unstyled">
